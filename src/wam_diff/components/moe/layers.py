...
from wam_diff.components.moe.utils import BackendConfig, initialize_linear_module
...
from wam_diff.components.moe.megatron.moe_utils import (
    MoEAuxLossAutoScaler,
    weighted_bias_swiglu_impl,
)
from wam_diff.components.moe.megatron.token_dispatcher import MoEConfig as MegatronMoEConfig
from wam_diff.components.moe.megatron.token_dispatcher import MoEFlexTokenDispatcher
...
class Gate(nn.Module):
    ...
    def forward(
        ...
        if self.bias_update_factor > 0 and self.training:
            assert expert_load is not None
