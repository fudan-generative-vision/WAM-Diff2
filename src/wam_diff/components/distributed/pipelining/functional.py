...
from wam_diff.components.distributed.pipelining.hf_utils import patch_hf_model_for_pp
...
def pipeline_model(
    ...
    *,
    ...
    if patch_stage_backward_maybe_with_nosync:
        from wam_diff.components.moe.fsdp_mixin import patched_backward_maybe_with_nosync
