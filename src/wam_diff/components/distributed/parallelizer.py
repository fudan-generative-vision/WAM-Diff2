...
from wam_diff.components.distributed.optimized_tp_plans import PARALLELIZE_FUNCTIONS
from wam_diff.components.distributed.parallel_styles import translate_to_lora
...
# Import as module so tests can patch wam_diff.components.distributed.parallelizer_utils.fully_shard_by_dtype
import wam_diff.components.distributed.parallelizer_utils as parallelizer_utils
