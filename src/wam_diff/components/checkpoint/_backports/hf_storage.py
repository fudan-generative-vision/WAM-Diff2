...
from wam_diff.components.checkpoint._backports._fsspec_filesystem import FsspecReader, FsspecWriter
from wam_diff.components.checkpoint._backports.consolidate_hf_safetensors import consolidate_safetensors_files
from wam_diff.components.checkpoint._backports.filesystem import SerializationFormat
from wam_diff.components.checkpoint._backports.hf_utils import (
    CUSTOM_METADATA_KEY,
    DATA_OFFSETS_KEY,
